    ...
    async def async_step_init(self, user_input: dict = None):
        ...
        if user_input is None:
            ...
            Init_Schema={
                        ...
                        vol.Required(
                            CONF_SELECTIVITY_H, 
                            default=options.get(CONF_SELECTIVITY_H, config.get(CONF_SELECTIVITY_H,"1"))
                        ): vol.In(["0", "1", "2", "3", "4", "5"]),
                        vol.Required(
                            CONF_SELECTIVITY_L, 
                            default=options.get(CONF_SELECTIVITY_L, config.get(CONF_SELECTIVITY_L,"1"))
                        ): vol.In(["0", "1", "2", "3", "4", "5"]),
                        vol.Required(
                            CONF_SENSITIVITY_H, 
        ...
        data[CONF_AUTOMATIC_ADD] = user_input.get(CONF_AUTOMATIC_ADD,True)
        ...
        data[CONF_SELECTIVITY_H] = user_input.get(CONF_SELECTIVITY_H,1)
        data[CONF_SELECTIVITY_L] = user_input.get(CONF_SELECTIVITY_L,1)
